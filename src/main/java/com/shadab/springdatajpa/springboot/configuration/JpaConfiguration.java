package com.shadab.springdatajpa.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.shadab.springdatajpa.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.shadab.springdatajpa.springboot.model" });
	...
	private Properties jpaProperties() {
		...
		System.out.println( environment.getRequiredProperty("datasource.sampleapp.hibernate.dialect"));
